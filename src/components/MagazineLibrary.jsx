...
export default function MagazineLibrary() {
  ...
  const issues = [
    ...
    },
    {
      ...
      coverAlt: 'Couverture du magazine OCEANS, Juillet 2026, édition française',
    ...
    },
    {
      ...
      coverAlt: 'Couverture du magazine OCEANS, Août 2026, édition française, Vol. 04',
      vol: 'Édition d\'Août · Vol. 01, Numéro 03',
      titleKey: "L'Avenir de l'Afrique est Vert",
      bodyKey: 'Faire naître la renaissance agricole — ainsi que le parcours de Karen Hendrickson vers le Ghana, et bien plus dans ce numéro.',
  ...
  return (
    <section className="max-w-[1180px] mx-auto px-4 py-14 sm:px-6 sm:py-[90px]" id="issues">
      <div className="flex justify-between items-end gap-6 mb-11 flex-wrap">
        <h2 className="text-navy-deep" style={{ fontSize: 'clamp(26px, 3.4vw, 34px)' }}>
          {t('issuesHeading')}
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {issues.map((issue) => (
          ...
          >
            <div className="relative overflow-hidden bg-navy-deep" style={{ aspectRatio: '3 / 4' }}>
